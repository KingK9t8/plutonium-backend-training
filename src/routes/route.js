...
// *write an api which gives the missing number in an array of integers starting from 1….e.g [1,2,3,5,6,7] : 4 is missing. Your route code will look like this:
router.get("/sol1", function (req, res) {
	...
	let supposedSum = ((arr.length + 1) / 2) * (lastNumber + firstNumber);
	let missingNumber = supposedSum - sumOfArr;
	///LOGIC WILL GO HERE
	res.send({ data: missingNumber });
});

// *-write an api which gives the missing number in an array of integers starting from anywhere….e.g [33, 34, 35, 37, 38]: 36 is missing .Your route code will look like this
